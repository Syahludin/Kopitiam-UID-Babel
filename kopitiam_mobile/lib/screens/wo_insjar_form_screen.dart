    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          unselectedLabelColor: const Color(0xFFB8DCEF),
          indicatorColor: const Color(0xFF00E5FF),
          tabs: const [Tab(text: 'Work Order'), Tab(text: 'Temuan')],
        ),
      ),
      body: Column(
        children: [
          ...
          if (_readOnly)
            Container(
              ...
              child: const Row(
                children: [
                  Icon(Icons.lock_rounded, size: 18, color: Color(0xFF047857)),
                  SizedBox(width: 8),
                  Expanded(
                    child: Text(
                      'WO selesai. Seluruh data hanya dapat dilihat.',
                      style: TextStyle(
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: const Row(
                            ...
                            children: [
                              Icon(Icons.lock_rounded, size: 17, color: muted),
                              SizedBox(width: 6),
                              Text(
                                'Read-only',
                                style: TextStyle(
