...
function makeBackend(headers, opts = {}) {
  ...
  vm.createContext(sandbox); vm.runInContext(read("SecurityValidation.js"), sandbox); vm.runInContext(read("Code.js"), sandbox); vm.runInContext(read("TemuanSheetHelpers.js"), sandbox); vm.runInContext(read("IdempotentUpload.js"), sandbox);
