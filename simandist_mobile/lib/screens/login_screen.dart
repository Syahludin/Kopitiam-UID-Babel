    ...
    try {
      ...
      if (result['success'] == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Login online berhasil, ${result['username']}'),
          ),
        );
      } else {
        setState(
      ...
      if (offline != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Mode offline aktif. Data lokal digunakan.'),
          ),
        );
      } else {
        setState(
          () => _error = 'Tidak dapat terhubung ke API dan akun ini belum tersimpan untuk mode offline.',
        );
      }
    } finally {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Gunakan Akun yang Terdaftar - Format akun (Kode ULP.Tim)',
