    ...
    try {
      ...
      if (result['success'] == true) {
        ...
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (_) => DashboardScreen(sesi: result)),
        );
      } else {
        setState(
      ...
      if (offline != null) {
        ...
        if (!mounted) return;
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (_) => DashboardScreen(sesi: offline)),
        );
      } else {
        setState(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            disabledForegroundColor: AppColors.navy700,
                            shape: RoundedRectangleBorder(
