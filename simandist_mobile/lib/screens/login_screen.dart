        ...
        child: Stack(
          children: [
            ...
            const Positioned(
              ...
              left: 0,
              right: 0,
              child: Text('Sistem Manajemen Distribusi © 2026 · PLN UID Babel', textAlign: TextAlign.center, style: TextStyle(fontSize: 11, color: AppColors.neutral500)),
            ),
          ],
        ),
      ),
...
class _PlnBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: .15), blurRadius: 8, offset: const Offset(0, 3))],
        ),
...
class _LoginSheetState extends State<_LoginSheet> {
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: _loading
                              ? const Row(mainAxisAlignment: MainAxisAlignment.center, children: [SizedBox(width: 19, height: 19, child: CircularProgressIndicator(strokeWidth: 2.5, color: AppColors.navy700)), SizedBox(width: 10), Text('Verifikasi Akun', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w800))])
  ...
  Widget _field(TextEditingController controller, String hint, IconData icon, {bool obscure = false, Widget? suffix}) {
    return Container(
      height: 48,
