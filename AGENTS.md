...
- Workspace ID: `a20e1c1e-ede5-45f3-a018-3bc1b0801e8b`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/a20e1c1e-ede5-45f3-a018-3bc1b0801e8b.
...
2. `npx ngodingpakeai connect --workspace a20e1c1e-ede5-45f3-a018-3bc1b0801e8b --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/a20e1c1e-ede5-45f3-a018-3bc1b0801e8b. Only pass on links the CLI actually printed — never assemble one from an id yourself.
